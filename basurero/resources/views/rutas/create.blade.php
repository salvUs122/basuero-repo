                    ...
                    <div class="bg-white rounded-xl card-shadow overflow-hidden">
                        <div class="gradient-primary p-6 text-white">
                            <div class="flex justify-between items-center">
                                <div>
                                    <p class="text-blue-100 text-sm font-medium">INFORMACION DE LA RUTA</p>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <div class="flex justify-between text-xs text-gray-500">
                                                <span>Minima precision</span>
                                                <span>Maxima desviacion</span>
                                            </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Usa "Dibujar Linea" y traza el recorrido</p>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-xl card-shadow p-6 h-full">
                        ...
                        <div id="estado-dibujo" class="mb-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <p class="text-yellow-800 font-medium">Aun no has dibujado la ruta</p>
                                    <p class="text-yellow-700 text-sm mt-1">
                                        Usa "Dibujar Linea" para trazar el recorrido y luego "Guardar dibujo".
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 flex flex-wrap gap-2">
                            <button type="button" id="btn-dibujar-linea"
                                    class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                                <i class="fas fa-draw-polygon mr-2"></i> Dibujar Linea
                            </button>

                            <button type="button" id="btn-guardar-dibujo"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function pintarEstadoFalta() {
            ...
            estadoDibujo.innerHTML = `
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-yellow-800 font-medium">Aun no has guardado el dibujo</p>
                        <p class="text-yellow-700 text-sm mt-1">
                            Dibuja una linea y presiona "Guardar dibujo".
                        </p>
                    </div>
                </div>
            `;
        ...
        btnGuardarDibujo.addEventListener('click', function() {
            ...
            // Guardamos SOLO la geometria (LineString)
